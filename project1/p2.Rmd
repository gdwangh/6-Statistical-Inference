...
qt(1-alpha/2, 36.55)
```
Because TS(t = `r tt$statistic`) > qt(1-alpha,`r tt$parameter`)( = `r qt(1-alpha,tt$parameter)`), H0 is rejected.
...
### Conclusion
By 95% confidence interval, tooth growth by OJ is larger than by VC when dose is 0.5 or 1, but when dose is 2, tooth growth by OJ and by VC is same.
