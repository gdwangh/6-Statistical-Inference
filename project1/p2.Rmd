...
1. The more dose is, the more length tooth grows
2. The len fits approximately normal distribution and for n is only 60, fit T distribution
...
1. The more dose is, the more length tooth grows
2. when the dose is not large enough(<2mg), the OJ is better for tooth growth than VC .
3. When the dose is large enough(2mg), the OJ and the VC are same with each other for tooth growth. 
